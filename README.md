...
# 🛠️ Pre-Class Setup
Before to start, ensure your environment is ready:
...
In `menu/models.py`, define what a "Dish" looks like.
...
In `menu/views.py`, write the logic to fetch the dishes.
